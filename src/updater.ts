...
const GITHUB_REPO = 'cpptools-proxy-patcher';
const VSIX_PREFIX = 'cpptools-proxy-patcher-';
const EXTENSION_ID = 'embedd-team.cpptools-proxy-patcher';
const EXTENSION_DISPLAY_NAME = 'C/C++ Tools Proxy Patcher';
const CONFIG_SECTION = 'CpptoolsProxyPatcher';
